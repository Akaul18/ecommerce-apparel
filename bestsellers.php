...
?>
<div class="row">
	<div class="col menu letspace" style="margin-top:2em;margin-bottom:2em;"><h6>BESTSELLERS</h6></div>
</div>
...
<?php while($row = mysqli_fetch_assoc($res)){
	...
	<a href="product-page.php?ref='.base64_encode($row['prod_id']).'" style="color:#333;text-decoration:none;">
